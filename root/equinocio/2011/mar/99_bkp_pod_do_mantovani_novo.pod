...
A linguagem Perl tem o maior repositório do mundo de código reutilizável, L<CPAN/http://search.cpan.org/> além do código ter uma excelente documentação, os códigos tem uma camada de testes que garante as funcionalidades funcionarem no seu ambiente.
