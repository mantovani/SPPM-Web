...
Outro grande nome deste ramo, é Edward Tufle que disse que este trabalho de Jacques I<"prevê um estudo aprofundado de diferentes técnicas gráficas (forma, orientação, cor, textura, volume, tamanho) para localizar e sinalizar variações quantitativas, geralmente sobre o espaço geográfico ou ao longo do tempo.">.
...
<center>
<img src="/static/images/equinocio/2011/mar/infograficos/800px-Kepler-world.jpg">
</center>
...
Por isto em muitos casos é interessante utilizar uma metodologia de que você irá oferecer inicialmente várias métricas, para que você possa 'tringular' elas e criar estratégias e até métricas novas.
...
Por isto escolher os números certos pode ser possivel apenas com um determinado tempo, para você consiga provar os fenômenos práticos com os números escolhidos.
...
Este artigo tem como objetivo oferecer um levantamento em relação às idéias relacionadas a infografia, e quais os passos para conseguir enviar dados de forma dinâmica ou não relacionado a uma quantidade de dados.
...
O trabalho não é só em ter os dados, mas organizar eles de forma que fique simples o trabalho do design de informação, além de que como foi abordado existe um interesse grande para que os dados sejam compartilhados, reutilizados e principalmente para que exista um ecosistema para formação de novas ideias baseado em um processo colaborativo.
	...
	Mas se você tiver uma idéia e eu tiver uma idéia 
	e nós trocamos idéias, 
...
Synergy map, how to map out your current strategy - L<http://http://www.agileweboperations.com/synergy-map-how-to-map-out-your-current-strategy-part-1-of-2>.
...
Pela revisão do artigo, conversas e idéias:
