...
Ada, C#, D, Eiffel, Erlang, Euphoria, Go, Guile, Haskell, Java, Lisp, Lua, ML, Objective C, Pascal, Perl, PHP, Pike, Pliant, Python, Ruby, Smalltalk, and Tcl.
...
Nesse artigo vamos usar alguns truques que só é possível com o nível de interface com o teclado que o SDL oferece. É apenas uma demonstração, mas o objetivo
é mostrar o conceito que pode ser aplicado para B<qualquer coias que a sua imaginação possa pensar>.
...
O código faz exatamente o que foi citado acima, você sabe quando a teclado foo foi apertada e quando você soltou a tecla.
...
O grande truque é o SDL nos oferecer a informação de quando as tecla está apertada e quando a tecla é solta. Com isso podemos
apertar multiplas técnicas simultaneamente, só precisamos pegar a "frag" das teclas no Arduino.
