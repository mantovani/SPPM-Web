...
=head1 Instalação de Aplicações Perl Catalyst
...
O Makefile.PL deve listar as dependências do seu software para que ele seja instalado corretamente. Ou seja, quando você executar um: C<make install>, o instalador vai verificar se as dependências estão instaladas e instalá-las caso necessário.
